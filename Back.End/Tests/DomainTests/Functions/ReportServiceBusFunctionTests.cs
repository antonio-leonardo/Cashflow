using Cashflow.Functions.Report;
...
{
    public class ReportServiceBusFunctionTests
    {
        [Fact]
        public async Task RunAsync_ShouldDispatch_Envelope_ToProcessor()
        {
            ...
            var logger = new Mock<ILogger<ReportServiceBusFunction>>();
            var sut = new ReportServiceBusFunction(processor.Object, logger.Object);
        ...
        private static EventEnvelope<TransactionCreatedEventV1> BuildEnvelope()
        {
            ...
            return new EventEnvelope<TransactionCreatedEventV1>(
                ...
                new MessageMetadata(
                    ...
                    Source: nameof(ReportServiceBusFunctionTests),
                    TenantId: null,
